...
ima = PhotoImage(file = 'C:\\Users\\coolg\\OneDrive\\Desktop\\covid\\main.png')
...
def about():    
    ...
    ima = PhotoImage(file = 'C:\\Users\\coolg\\OneDrive\\Desktop\\covid\\18.png')
    label = tk.Label(window, image = ima)
...
def faq():
    ...
    ima = PhotoImage(file = 'C:\\Users\\coolg\\OneDrive\\Desktop\\covid\\img1.png')
    label = tk.Label(window, image = ima)
    def question1():
